      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-sm mx-auto">
          ...
          <div className="space-y-3 max-w-xs mx-auto">
            <Link
              to="/catalog"
              className="inline-block w-full px-8 py-3 border border-gray-200 bg-white text-gray-900 hover:bg-gray-50 font-light transition-colors duration-300 text-sm text-center"
            >
              Перейти в каталог
            </Link>
            ...
            <Link
              to="/"
              className="block w-full px-8 py-3 border border-gray-200 bg-gray-50 text-gray-700 hover:bg-gray-100 font-light transition-colors duration-300 text-sm text-center"
            >
              На главную
            </Link>
          </div>
