...
const Hero = () => {
  return (
    <section className="relative w-full bg-white border-b border-gray-100">
      <div className="py-8 md:py-16 flex flex-col lg:flex-row items-center min-h-[600px]">
        {/* Image */}
        <div className="flex-1 flex items-center justify-center mb-12 lg:mb-0 lg:pr-12">
          <div className="w-full max-w-lg overflow-hidden flex items-center justify-center">
            <img
              ...
              className="object-contain w-full h-auto md:max-h-144 max-h-112"
              onError={(e) => {
        ...
        {/* Content */}
        <div className="flex-1 flex flex-col items-center justify-center lg:pl-12">
          <h1 className="text-5xl lg:text-7xl font-light text-gray-900 mb-8 leading-tight">
            iPhone 15 Pro Max
          </h1>
          <p className="text-xl text-center lg:text-2xl text-gray-600 mb-8 font-light leading-relaxed">
            Титан. Очень прочный. Очень лёгкий. Очень айвон. Очень 15. Очень Pro. Очень Max.
          </p>
          <p className="text-lg text-gray-500 text-center mb-12 max-w-xl leading-relaxed">
