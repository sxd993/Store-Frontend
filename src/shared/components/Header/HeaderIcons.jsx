...
export const CartIcon = ({ itemCount }) => {
  return (
    <Link to="/cart" className="relative inline-block">
      {/* Твоя оригинальная иконка корзины */}
      <svg
        className="w-6 h-6"
        fill="none"
        stroke="currentColor"
      ...
      >
        <path
          ...
          strokeWidth={1.5}
          d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2 9h14l-2-9M9 21a2 2 0 11-4 0 2 2 0 014 0zm10 0a2 2 0 11-4 0 2 2 0 014 0z"
        />
      </svg>
...
export const MessageIcon = ({ telegramUrl = "https://t.me/your_username" }) => {
  return (
    <a
      href={telegramUrl}
      target="_blank"
